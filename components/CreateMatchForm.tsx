  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={isPending}
        className="tap-target btn-press btn-glow rounded-md bg-brand px-4 py-2 font-mono text-[11px] font-bold uppercase tracking-wide text-white disabled:opacity-60"
      >
        Add match
      </button>
    </form>
